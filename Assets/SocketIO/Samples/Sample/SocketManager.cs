...
public class SocketManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        header.Add("2323", "fasdfdg");
        //TODO: check the Uri if Valid.
        var uri = new Uri("http://192.168.2.233:8123");
        ...
        {
            Debug.Print(response.GetValue().GetRawText());
        });
    }

    public void EmitTest()
    {
        string eventName = "MSG";  //EventNameTxt.text.Trim().Length < 1 ? "hello" : EventNameTxt.text;
