...
namespace StarForce.Editor.DataTableTools
{
    ...
    {
        private const string DataTablePath = "Assets/Core/DataTables";
        private const string CSharpCodePath = "Assets/Core/Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/Core/Configs/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "Tuwan");
